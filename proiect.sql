...
INSERT INTO `costumers` (`id`, `email`, `name`, `id_adress`) VALUES
(12, 'ion@mail.com', 'ion ', 12);

-- --------------------------------------------------------

--
-- Table structure for table `costumers_adress`
--

CREATE TABLE `costumers_adress` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `costumers_adress`
--

INSERT INTO `costumers_adress` (`id`, `country`, `city`, `street`) VALUES
...
--
-- Indexes for table `costumers_adress`
--
ALTER TABLE `costumers_adress`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `costumers_adress`
--
ALTER TABLE `costumers_adress`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `costumers`
  ADD CONSTRAINT `fk_costumer_costumer_adress` FOREIGN KEY (`id_adress`) REFERENCES `costumers_adress` (`id`);
...
--
ALTER TABLE `shopping_carts`
  ADD CONSTRAINT `fk_clientid_costumer_id` FOREIGN KEY (`client_id`) REFERENCES `costumers` (`id`);
